...
from notifications.views import create_task_notification,WorkerAcceptTask,WorkerNotificationList,ClientNotificationList,WorkerSeenTask
...
urlpatterns = [
    ...
    path('api/Client/notifications/create/', create_task_notification),
    ...
    path('api/Worker/notifications/taskReject/', ClientNotificationList),   
